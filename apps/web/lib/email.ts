...
export async function sendDeadlineReminderEmail(
  ...
  await resend.emails.send({
    ...
    html: baseTemplate(`
      ...
      <div style="background:${urgent ? "#fef2f2" : "#fafafa"};border:1px solid ${urgent ? "#fca5a5" : "#e5e7eb"};border-left:4px solid ${urgent ? "#ef4444" : "#A855F7"};border-radius:8px;padding:20px">
        <p style="margin:0;font-size:17px;font-weight:700;color:#0C0C0C">${courseTitle}</p>
...
export async function sendInvitationEmail(
  ...
  await resend.emails.send({
    ...
    html: baseTemplate(`
      ...
      <div style="background:#fafafa;border:1px solid #e5e7eb;border-left:4px solid #A855F7;border-radius:8px;padding:20px;margin-bottom:24px">
      ...
      <a href="${inviteUrl}"
         style="display:inline-block;background:#A855F7;color:#0C0C0C;font-weight:700;font-size:15px;
  ...
  await resend.emails.send({
    ...
    html: baseTemplate(`
      ...
      <a href="${data.dashboardUrl}"
         style="display:inline-block;background:#A855F7;color:#0C0C0C;font-weight:700;font-size:14px;

...
export async function POST(req: NextRequest) {
  ...
  const prompts: Record<string, string> = {
    description: `Escribe una descripción atractiva y profesional (2-3 párrafos) para un curso de formación llamado "${courseTitle}" dentro del Técnico Superior en Acondicionamiento Físico. Incluye objetivos de aprendizaje y a quién va dirigido. Responde solo con el texto, sin títulos ni markdown.`,

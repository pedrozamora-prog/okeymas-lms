          ...
          <CardContent className="pt-4 pb-4 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={savingMod}
                className="bg-primary text-yelau-black hover:bg-primary/90 font-bold flex-shrink-0"
              >
    ...
    <Card className="overflow-hidden">
      ...
      {expanded && (
        <CardContent className="pt-0 pb-4 px-4 space-y-2">
          ...
          {/* Add lesson form */}
          {addingLesson ? (
            <div className="mt-3 p-4 rounded-lg border border-primary/30 bg-primary/5 space-y-3">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full text-xs rounded-md border border-input bg-background px-3 py-2 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 resize-none"
                />
              </div>
            ...
            <button
              ...
              className="flex items-center gap-2 w-full px-3 py-2 text-xs text-muted-foreground hover:text-foreground border border-dashed border-border hover:border-primary/40 rounded-lg transition-colors mt-1"
            >
    ...
    <div className="p-4 rounded-lg border border-primary/30 bg-primary/5 space-y-3">
                ...
                <div key={qi} className="space-y-2 pb-3 border-b border-border/50 last:border-0 last:pb-0">
                  ...
                  <div className="flex gap-2 items-start">
                    ...
                    <input value={q.question} placeholder="Texto de la pregunta…"
                      ...
                      className="flex-1 text-xs bg-muted/50 border border-border rounded px-2 py-1 text-foreground focus:outline-none focus:ring-1 focus:ring-primary/50" />
                      ...
                      {q.options.map((opt, oi) => (
                        <div key={oi} className="flex items-center gap-1.5">
                          ...
                          <input value={opt}
                            ...
                            className={cn("flex-1 text-[11px] bg-transparent border-b border-border/30 focus:border-primary/50 focus:outline-none py-0.5 text-foreground",
                  ...
                  <input value={q.explanation??""} placeholder="Explicación (opcional, se muestra tras responder)…"
                    ...
                    className="w-full ml-4 text-[10px] bg-transparent border-b border-border/20 focus:border-primary/30 focus:outline-none py-0.5 text-muted-foreground" />
                </div>
              ))}
            </div>
          )}
      ...
      <div className="flex gap-2">
        <Button size="sm" onClick={handleSave} disabled={saving}
          className="bg-primary text-yelau-black hover:bg-primary/90 font-bold gap-1.5">
